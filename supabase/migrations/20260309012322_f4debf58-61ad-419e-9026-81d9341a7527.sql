...
USING (
  key = ANY (ARRAY[
    ...
    'hero_bg_gradient', 'hero_title_color', 'hero_subtitle_color',
    'hero_accent_color', 'hero_badge_bg', 'hero_badge_color',
    'hero_title_font', 'hero_body_font', 'hero_title_size', 'hero_subtitle_size', 'hero_spacing'
  ]::text[])
);